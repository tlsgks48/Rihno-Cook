...
class Menu4CommentAdapter(internal var context: Context?,
                          internal var commentList:ArrayList<Comment>) :
    RecyclerView.Adapter<Menu4CommentAdapter.MyViewHolder>() {
        ...
        var onEditMenu:MenuItem.OnMenuItemClickListener = MenuItem.OnMenuItemClickListener { item: MenuItem? ->
            ...
            when (item!!.itemId) {
                ...
                1002 -> {
                    ...
                    compositeDisposable.add(myAPI.recipe_comment_delete4(commentList.get(adapterPosition).id)
