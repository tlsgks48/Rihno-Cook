...
class DetailUnitAdapter(internal var context: Context?,
                     internal var DunitList:ArrayList<Unit>) :
    RecyclerView.Adapter<DetailUnitAdapter.MyViewHolder>(){
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): MyViewHolder {
        val itemView = LayoutInflater.from(context)
            .inflate(R.layout.detail_unit_item,p0,false)
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        init {
            Dunit_title = itemView.findViewById(R.id.Detail_unit_item_text) as TextView
            Dunit_amount = itemView.findViewById(R.id.Detail_unit_item_unit) as TextView
